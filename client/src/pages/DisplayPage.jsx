...
const MUSIC_MODE_CONFIG = {
  arabesk: {
    ...
    icon: '🎻',
    bg: 'radial-gradient(ellipse at center, rgba(40, 15, 5, 0.6) 0%, rgba(10, 3, 0, 0.75) 100%)',
  ...
  rock: {
    ...
    icon: '🎸',
    bg: 'radial-gradient(ellipse at center, rgba(30, 5, 5, 0.6) 0%, rgba(5, 0, 0, 0.75) 100%)',
  ...
  '90s-pop': {
    ...
    icon: '💿',
    bg: 'radial-gradient(ellipse at center, rgba(20, 5, 30, 0.6) 0%, rgba(5, 0, 10, 0.75) 100%)',
  ...
  'turkish-delight': {
    ...
    icon: '🌹',
    bg: 'radial-gradient(ellipse at center, rgba(25, 5, 15, 0.6) 0%, rgba(5, 0, 5, 0.75) 100%)',
  ...
  tech: {
    ...
    icon: '🎧',
    bg: 'radial-gradient(ellipse at center, rgba(0, 5, 20, 0.6) 0%, rgba(0, 2, 8, 0.75) 100%)',
  ...
  latino: {
    ...
    icon: '💃',
    bg: 'radial-gradient(ellipse at center, rgba(30, 8, 0, 0.6) 0%, rgba(8, 2, 0, 0.75) 100%)',
  ...
  rap: {
    ...
    icon: '🎤',
    bg: 'radial-gradient(ellipse at center, rgba(20, 0, 0, 0.6) 0%, rgba(5, 0, 0, 0.75) 100%)',
