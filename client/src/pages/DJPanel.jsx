    ...
    <div className="dj-panel dj-compact">
      ...
      <div className="djc-row1">
        ...
        <button className="djc-reji-link-btn" onClick={() => {
          ...
          const msg = lang === 'tr'
            ? `╔══════════════════════════╗\n║  ██▀███ ▓█████  ███▄ ▄███▓██▓ ██ ▄█▀  ██████ \n║ ▓██ ▒ ██▓█   ▀ ▓██▒▀█▀██▓██▒██▄█▒ ▒██    ▒ \n║ ▓██ ░▄█ ▒███   ▓██    ▓██▒██▓███▄░ ░ ▓██▄   \n║ ▒██▀▀█▄ ▒▓█  ▄ ▒██    ▒██░██▓██ █▄   ▒   ██▒\n║ ░██▓ ▒██▒░▒████▒▒██▒   ░██░██▒██▒ █▄▒██████▒▒\n║          𝗕 𝗢 𝗫  ·  DJ Platform\n╚══════════════════════════╝\n\n🎬 Reji Ekranı — ${event.name}\n🔗 ${url}\n\nBu linki tarayıcıda açarak sahne ekranını canlı izleyebilirsiniz.\n\n📋 Alt barda şu kontroller mevcut:\n• 📺 Ekran Yazısı — Sahne başlığını değiştir\n• 📜 Kayan Yazı — Ticker mesajını güncelle\n• 🎬 Tören — Açılış / Kapanış başlat veya durdur\n• 💡 Spotlight — Sahneye büyük mesaj gönder (5sn)\n• 🔲 Karartma — Ekranı anında karart / aydınlat\n• ⏱ Geri Sayım — 3 veya 5 sn geri sayım başlat\n• 💬 Chat — DJ ile anlık mesajlaşma\n\n━━━━━━━━━━━━━━━━━━━━\nPowered by Remiks İstanbul\nremiksistanbul.com`
            : `╔══════════════════════════╗\n║  ██▀███ ▓█████  ███▄ ▄███▓██▓ ██ ▄█▀  ██████ \n║ ▓██ ▒ ██▓█   ▀ ▓██▒▀█▀██▓██▒██▄█▒ ▒██    ▒ \n║ ▓██ ░▄█ ▒███   ▓██    ▓██▒██▓███▄░ ░ ▓██▄   \n║ ▒██▀▀█▄ ▒▓█  ▄ ▒██    ▒██░██▓██ █▄   ▒   ██▒\n║ ░██▓ ▒██▒░▒████▒▒██▒   ░██░██▒██▒ █▄▒██████▒▒\n║          𝗕 𝗢 𝗫  ·  DJ Platform\n╚══════════════════════════╝\n\n🎬 Crew Display — ${event.name}\n🔗 ${url}\n\nOpen this link in your browser to view the live stage display.\n\n📋 Bottom bar controls:\n• 📺 Screen Text — Change stage title\n• 📜 Ticker — Update scrolling text\n• 🎬 Ceremony — Start / Stop opening or closing\n• 💡 Spotlight — Big message to stage (5s)\n• 🔲 Blackout — Instantly black out / restore\n• ⏱ Countdown — 3 or 5 sec countdown\n• 💬 Chat — Real-time messaging with DJ\n\n━━━━━━━━━━━━━━━━━━━━\nPowered by Remiks İstanbul\nremiksistanbul.com`;
